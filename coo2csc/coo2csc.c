...
int main() {
  ...
  // Expected output:
  // csr_val: 10 20 30 40 50 60 70 80 (nnz)
  // csr_col:  0  1  1  3  2  3  4  5 (nnz)
  // csr_row:  0  2  4  7  8          (rows+1)
  ...
  // Expected output:
  // csc_val:  1 2 1 2 2 1 2 (nnz)
  // csc_col:  0 1 2 4 6 7 (cols+1)
  // csc_row:  1 3 2 4 0 4 4 (nnz)
